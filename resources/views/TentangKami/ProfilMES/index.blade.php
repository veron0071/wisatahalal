            ...
            <div class="max-w-4xl mx-auto text-left text-gray-700 space-y-6">
                ...
                <div class="pt-6 mt-8 border-t">
                    ...
                    <div class="space-y-4 text-gray-600">
                        <p>
                            <strong class="font-semibold text-gray-800 block">Akta Pendirian:</strong>
                        ...
                        <p>
                            <strong class="font-semibold text-gray-800 block">Perubahan Akta (terakhir):</strong>
                        ...
                        <p>
                            <strong class="font-semibold text-gray-800 block">Pengurus Daerah Masyarakat Ekonomi Syariah Kabupaten Kendal:</strong>
