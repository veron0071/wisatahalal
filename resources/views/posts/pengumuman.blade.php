    ...
    <div class="container mx-auto px-6 md:px-12 py-12">
        ...
        @else
            <div class="text-center py-16">
                <h2 class="text-2xl font-semibold text-gray-700">Belum Ada Pengumuman</h2>
                <p class="text-gray-500 mt-2">Saat ini belum ada pengumuman yang dipublikasikan.</p>
            </div>
        @endif
    </div>
        ...
        function pageData() {
            ...
            return {
                ...
                async loadMore() {
                    ...
                    try {
                        // PERUBAHAN PENTING: Mengarah ke route API pengumuman
                        const response = await fetch(`{{ route('api.pengumuman.loadmore') }}?page=${nextPage}`);
