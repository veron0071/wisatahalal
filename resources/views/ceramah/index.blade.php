...
>>>>>>> 709a15963d52981301348838efc66f2e9d49410d
            <section class="mb-16">
...
<<<<<<< HEAD
                            ...
                            <div class="md:w-1/2">
                                <template x-if="featured.foto">
                                    <img :src="'/storage/' + featured.foto" :alt="featured.judul" class="rounded-xl shadow-lg w-full h-auto object-cover">
                                </template>
                            </div>
=======
...
<<<<<<< HEAD
                    ...
                    @foreach ($ceramahs as $ceramah)
                        <div @click="setFeatured({{ $loop->index }})" class="cursor-pointer bg-white rounded-2xl custom-shadow overflow-hidden flex flex-col transition-transform duration-300 custom-shadow-hover hover:-translate-y-1.5">
                            @if ($ceramah->foto)
                                <img src="{{ asset('storage/' . $ceramah->foto) }}" alt="{{ $ceramah->judul }}" class="w-full h-48 object-cover">
                            @else
                                <div class="w-full h-48 bg-gray-200 flex items-center justify-center"><span class="text-gray-400">Tidak ada foto</span></div>
                            @endif
                            <div class="p-6 flex-grow flex flex-col">
                                <h3 class="text-xl font-bold text-jabal-green mb-4 text-center">{{ $ceramah->judul }}</h3>
                                
                                {{-- DIUBAH MENJADI video_url --}}
                                <a href="{{ $ceramah->video_url }}" target="_blank" class="mt-auto block w-full bg-white border border-gray-200 text-center text-jabal-green font-semibold px-6 py-2.5 rounded-full hover:bg-jabal-green hover:text-white transition-colors">
                                    Tonton Kajian
                                </a>
=======
                    @foreach ($ceramahs as $ceramah)
