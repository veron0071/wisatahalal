    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-xl font-semibold text-gray-900">Data Publikasi</h1>
                <p class="mt-2 text-sm text-gray-700">Daftar semua file publikasi yang tersimpan.</p>
            </div>
                                ...
                                @forelse ($publikasis as $item)
                                    <tr>
                                        <td
                                            ...
                                            {{ $item->nama }}</td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $item->kategori }}
                                        </td>
                                        <td
