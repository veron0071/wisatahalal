...
@section('title', 'Data Ceramah & Kajian')
@section('content')
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-xl font-semibold text-gray-900">Data Ceramah & Kajian</h1>
                <p class="mt-2 text-sm text-gray-700">Daftar semua ceramah yang terdata di sistem.</p>
            </div>
            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                <a href="{{ route('admin.ceramahs.create') }}"
        ...
        <div class="mt-8 flex flex-col">
            <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <div class="flex justify-end gap-x-4">
                                                <a href="{{ route('admin.ceramahs.show', $ceramah->id) }}"
                                                    class="text-gray-500 hover:text-indigo-600">Detail</a>
                                                <a href="{{ route('admin.ceramahs.edit', $ceramah->id) }}"
                                                    class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                                <form action="{{ route('admin.ceramahs.destroy', $ceramah->id) }}"
                                                    method="POST"
                    ...
                    <div class="mt-4">{{ $ceramahs->links() }}</div>
                </div>
            </div>
        </div>
    </div>
