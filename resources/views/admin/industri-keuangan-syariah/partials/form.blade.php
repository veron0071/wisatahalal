<div class="space-y-6">
    <div>
        <label for="judul" class="block text-sm font-medium text-gray-700">Judul / Nama</label>
        <div class="mt-1">
    ...
    <div>
        ...
        <div class="mt-1">
            <input
                ...
                id="foto" name="foto" type="file" {{ isset($item) ? '' : 'required' }}>
...
<div class="mt-8 pt-5 border-t border-gray-200">
    <div class="flex justify-end gap-3">
        <a href="{{ route('admin.industri-keuangan-syariah.index') }}"
