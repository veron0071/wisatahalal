    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-xl font-semibold text-gray-900">Industri Keuangan Syariah</h1>
                <p class="mt-2 text-sm text-gray-700">Kelola semua foto untuk galeri Industri Keuangan Syariah.</p>
            </div>
            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                <a href="{{ route('admin.industri-keuangan-syariah.create') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <div class="flex justify-end gap-x-4">
                                                <a href="{{ route('admin.industri-keuangan-syariah.edit', $item->id) }}"
                                                    class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                                <form
                                                    action="{{ route('admin.industri-keuangan-syariah.destroy', $item->id) }}"
                                                    method="POST"
