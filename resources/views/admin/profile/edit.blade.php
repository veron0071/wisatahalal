    ...
    <form method="POST" action="{{ route('admin.profile.update') }}">
        ...
        <div class="bg-white shadow sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg font-medium leading-6 text-gray-900">Edit Profil Anda</h3>
                <p class="mt-1 text-sm text-gray-500">Perbarui informasi nama dan password Anda.</p>
                ...
                <div class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email"
                            class="mt-1 block w-full bg-gray-200 border border-gray-300 rounded-md shadow-sm py-2 px-3 cursor-not-allowed"
