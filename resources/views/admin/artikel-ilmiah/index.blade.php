...
@section('title', 'Data Artikel Ilmiah')
@section('content')
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-xl font-semibold text-gray-900">Artikel Ilmiah</h1>
                <p class="mt-2 text-sm text-gray-700">Daftar semua artikel ilmiah yang dipublikasikan.</p>
            </div>
            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none"><a href="{{ route('admin.artikel-ilmiah.create') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <div class="flex justify-end gap-x-4">
                                                <a href="{{ route('admin.artikel-ilmiah.show', $artikel->id) }}"
                                                    class="text-gray-500 hover:text-indigo-600">Detail</a>
                                                <a href="{{ asset('storage/' . $artikel->file_artikel) }}" target="_blank"
                                                    class="text-green-600 hover:text-green-900">Unduh</a>
                                                <a href="{{ route('admin.artikel-ilmiah.edit', $artikel->id) }}"
                                                    class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                                <form action="{{ route('admin.artikel-ilmiah.destroy', $artikel->id) }}"
                                                    method="POST"
