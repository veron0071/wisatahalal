...
@section('title', 'Data Opini & Berita')
@section('content')
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                ...
                <p class="mt-2 text-sm text-gray-700">Daftar semua opini dan berita yang tersimpan.</p>
            </div>
        ...
        <div class="mt-8 flex flex-col">
            <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <div class="flex justify-end gap-x-4">
                                                ...
                                                <a href="{{ route('admin.opini-berita.edit', $item->id) }}"
                                                    class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                                <form action="{{ route('admin.opini-berita.destroy', $item->id) }}"
                                                    method="POST"
                    ...
                    <div class="mt-4">{{ $opiniBeritas->links() }}</div>
                </div>
            </div>
        </div>
    </div>
