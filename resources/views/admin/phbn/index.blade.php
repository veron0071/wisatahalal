...
@section('title', 'Data Peringatan Hari Besar Nasional')
@section('content')
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-xl font-semibold text-gray-900">Peringatan Hari Besar Nasional</h1>
                <p class="mt-2 text-sm text-gray-700">Daftar semua PHBN yang terdata.</p>
            </div>
            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none"><a href="{{ route('admin.phbn.create') }}"
        ...
        <div class="mt-8 flex flex-col">
            <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                        ...
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0"><img
                                                        ...
                                                        alt=""></div>
                                                <div class="ml-4">
                                                    <div class="font-medium text-gray-900">{{ $phbn->nama }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td
                                            ...
                                            <div class="flex justify-end gap-x-4">
                                                <a href="{{ route('admin.phbn.show', $phbn->id) }}"
                                                    class="text-gray-500 hover:text-indigo-600">Detail</a>
                                                <a href="{{ route('admin.phbn.edit', $phbn->id) }}"
                                                    class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                                <form action="{{ route('admin.phbn.destroy', $phbn->id) }}" method="POST"
                    ...
                    <div class="mt-4">{{ $phbns->links() }}</div>
                </div>
            </div>
        </div>
    </div>
