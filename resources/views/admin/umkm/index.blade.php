    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-xl font-semibold text-gray-900">Data UMKM</h1>
                <p class="mt-2 text-sm text-gray-700">Daftar semua UMKM yang terdata di sistem.</p>
            </div>
                                        ...
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0"><img
                                                        ...
                                                        alt=""></div>
                                                <div class="ml-4">
                                                    <div class="font-medium text-gray-900">{{ $umkm->nama_usaha }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            {{ $umkm->nama_pemilik }}</td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            @if ($umkm->sertifikat_halal)
                                                <span
                                                    class="inline-flex items-center rounded-full bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800">Ya</span>
                                            @else
                                                <span
                                                    class="inline-flex items-center rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800">Tidak</span>
                                            @endif
                                        </td>
                                        <td
